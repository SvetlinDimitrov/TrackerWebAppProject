...
class FoodControllerImpTest {
    ...
    void addFood_ValidCreateFoodDto_StatusCreated() throws Exception {
        ...
        mockMvc.perform(post("/api/food/customFood")
    ...
    void getAllCustomFoods_EmptyList_StatusOk() throws Exception {
        ...
        mockMvc.perform(get("/api/food/customFood/all")
                .contentType("application/json")
                .header("X-ViewUser", userToken))
    ...
    void getCustomFood_ValidUserTokenAndFoodName_StatusOk() throws Exception {
        ...
        mockMvc.perform(get("/api/food/customFood")
                .contentType("application/json")
                .param("foodName", "name")
                .param("amount", "1")
                .header("X-ViewUser", userToken))
    ...
    void deleteCustomFood_ValidUserTokenAndFoodName_StatusOk() throws Exception {
        ...
        mockMvc.perform(delete("/api/food/customFood")
                .contentType("application/json")
                .content(objectMapper.writeValueAsString(createCustomFood))
                .param("foodName", "name")
                .header("X-ViewUser", userToken))
    ...
    // private CustomFood generateCustomFood(String name, BigDecimal amount, BigDecimal calories) {
    //     CustomFood customFood = new CustomFood();
    //     customFood.setUserId(1L);
