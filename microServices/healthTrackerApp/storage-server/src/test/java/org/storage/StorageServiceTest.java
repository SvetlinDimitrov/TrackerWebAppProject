...
public class StorageServiceTest {
    ...
    @Test
    public void testGetAllByRecordId_ValidInput_ReturnsStorageView() throws InvalidJsonTokenException {
        Long recordId = 1L;
        Long userId = 1L;
    ...
    @Test
    public void testGetAllByRecordId_InvalidInput_throwsStorageException() throws InvalidJsonTokenException {
        Long recordId = 2L;
        Long userId = 2L;
        String userToken = getUserToken(userId);
    ...
    @Test
    public void testGetStorageByIdAndRecordId_ValidInput_ReturnsStorageView() throws StorageException, InvalidJsonTokenException {
    ...
    @Test
    public void testGetStorageByIdAndRecordId_InvalidInput_throwsStorageException()  {
    ...
    @Test
    public void testCreateStorage_NullStorageName_ReturnsDefaultStorageName() throws InvalidJsonTokenException {
    ...
    @Test
    public void testCreateStorage_ProvidedStorageName_StorageNameSavedCorrectly() throws InvalidJsonTokenException {
        Long recordId = 6L;
        Long userId = 6L;
        String userToken = getUserToken(userId);
        Mockito.when(storageRepository.save(storageCaptor.capture())).thenReturn(new Storage());
    ...
    @Test
    public void firstCreationStorage_assertFourStorages() throws InvalidJsonTokenException {
        Long recordId = 7L;
        Long userId = 7L;
        String userToken = getUserToken(userId);
    ...
    @Test
    public void testDeleteStorage_validInput() throws StorageException, InvalidJsonTokenException {
        Long recordId = 9L;
        Long userId = 9L;
        String userToken = getUserToken(userId);
    ...
    @Test
    public void testDeleteAllByRecordId_validInput() throws InvalidJsonTokenException {
        Long recordId = 10L;
        Long userId = 10L;
        String userToken = getUserToken(userId);
    ...
    @Test
    public void testAddFoodToStorage_singleFoodAdded_AddedCorrectlyFood() throws StorageException, FoodException, InvalidJsonTokenException {
        Long recordId = 11L;
        Long userId = 11L;
        String userToken = getUserToken(userId);
        ...
        storageService.addFood(storage.getId(), recordId, foodUpdate, userToken, false);
    ...
    @Test
    public void testChangeFood_WithEqualMeasurement_NothingChanges() throws StorageException, FoodException, InvalidJsonTokenException {
        Long recordId = 17L;
        Long userId = 17L;
        String userToken = getUserToken(userId);
        ...
        storageService.changeFood(storage.getId(), recordId, foodUpdate, userToken, false);
    ...
    @Test
    public void testChangeFood_WithDifferentLowerMeasurement_ChangesCorrectly() throws StorageException, FoodException, InvalidJsonTokenException {
        Long recordId = 19L;
        Long userId = 19L;
        String userToken = getUserToken(userId);
    ...
    @Test
    public void testRemoveFood_validInput() throws StorageException, FoodException, InvalidJsonTokenException {
        Long recordId = 23L;
        Long userId = 23L;
        String userToken = getUserToken(userId);
        ...
        storageService.removeFood(storage.getId(), recordId, food.getName(), userToken, false);
    ...
    public void testRemoveFood_invalidStorageInput_throwsStorageException() {
        ...
        assertThrows(StorageException.class,
            () -> storageService.removeFood(storage.getId(), recordId, "Apple", userToken, false));
    }
    ...
    public void testRemoveFood_invalidFoodInput_throwsFoodException() {
        ...
        assertThrows(FoodException.class,
            () -> storageService.removeFood(storage.getId(), recordId, "Invalid food name", userToken, false));
    }
