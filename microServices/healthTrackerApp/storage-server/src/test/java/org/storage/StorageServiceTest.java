...
public class StorageServiceTest {
    ...
    public void testAddFoodToStorage_singleFoodAdded_AddedCorrectlyFood() throws StorageException, FoodException {
        ...
        when(storageRepository.findByIdAndRecordId(storage.getId(), recordId)).thenReturn(Optional.of(storage));
        when(foodClient.getFoodByName(food.getName())).thenReturn(food);

        storageService.addFood(storage.getId(), recordId, foodUpdate);
    ...
    public void testAddFoodToStorage_TheSameFoodAddedMultiTimes_AddedCorrectlyFood()
        ...
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getCalories()).compareTo(resultedFood.getCalories() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getChloride()).compareTo(resultedFood.getChloride() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getChromium()).compareTo(resultedFood.getChromium() ) == 0);
        ...
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getFluoride()).compareTo(resultedFood.getFluoride() ) == 0);
        ...
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getMagnesium()).compareTo(resultedFood.getMagnesium() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getManganese()).compareTo(resultedFood.getManganese() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getMolybdenum()).compareTo(resultedFood.getMolybdenum() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getPhosphorus()).compareTo(resultedFood.getPhosphorus() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getPotassium()).compareTo(resultedFood.getPotassium() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getSelenium()).compareTo(resultedFood.getSelenium() ) == 0);
        ...
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getCarbohydrates()).compareTo(resultedFood.getCarbohydrates() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getFat()).compareTo(resultedFood.getFat() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getMonounsaturatedFat()).compareTo(resultedFood.getMonounsaturatedFat() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getPolyunsaturatedFat()).compareTo(resultedFood.getPolyunsaturatedFat() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getProtein()).compareTo(resultedFood.getProtein() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getSaturatedFat()).compareTo(resultedFood.getSaturatedFat() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getSugar()).compareTo(resultedFood.getSugar() ) == 0);
        assertTrue(getIncreaseTransformedValue(1.5, getApple().getTransFat()).compareTo(resultedFood.getTransFat() ) == 0);
    }
    ...
    public void testChangeFood_WithEqualMeasurement_NothingChanges() throws StorageException, FoodException {
        ...
        storageService.changeFood(storage.getId(), recordId, foodUpdate);
    ...
    public void testChangeFood_WithDifferentLowerMeasurement_ChangesCorrectly() throws StorageException, FoodException {
        ...
        assertTrue(getDecreesTransformedValue(getApple().getMagnesium() , 2).compareTo(resultedFood.getMagnesium() ) == 0);
        assertTrue(getDecreesTransformedValue(getApple().getManganese() , 2).compareTo(resultedFood.getManganese() ) == 0);
        assertTrue(getDecreesTransformedValue(getApple().getMolybdenum() , 2).compareTo(resultedFood.getMolybdenum() ) == 0);
        assertTrue(getDecreesTransformedValue(getApple().getPhosphorus() , 2).compareTo(resultedFood.getPhosphorus() ) == 0);
        assertTrue(getDecreesTransformedValue(getApple().getPotassium() , 2).compareTo(resultedFood.getPotassium() ) == 0);
        ...
        assertTrue(getDecreesTransformedValue(getApple().getCarbohydrates() , 2).compareTo(resultedFood.getCarbohydrates() ) == 0);
        assertTrue(getDecreesTransformedValue(getApple().getFat() , 2).compareTo(resultedFood.getFat() ) == 0);
        assertTrue(getDecreesTransformedValue(getApple().getMonounsaturatedFat() , 2).compareTo(resultedFood.getMonounsaturatedFat() ) == 0);
        assertTrue(getDecreesTransformedValue(getApple().getPolyunsaturatedFat() , 2).compareTo(resultedFood.getPolyunsaturatedFat() ) == 0);
        assertTrue(getDecreesTransformedValue(getApple().getProtein() , 2).compareTo(resultedFood.getProtein() ) == 0);
        assertTrue(getDecreesTransformedValue(getApple().getSaturatedFat() , 2).compareTo(resultedFood.getSaturatedFat() ) == 0);
    ...
    public void testRemoveFood_validInput() throws StorageException, FoodException {
        ...
        storageService.removeFood(storage.getId(), recordId, food.getName());
    ...
    public void testRemoveFood_invalidStorageInput_throwsStorageException() {
        ...
        assertThrows(StorageException.class,
                () -> storageService.removeFood(storage.getId(), recordId, "Apple"));
    }
    ...
    public void testRemoveFood_invalidFoodInput_throwsFoodException() {
        ...
        assertThrows(FoodException.class,
                () -> storageService.removeFood(storage.getId(), recordId, "Invalid food name"));
    }
