...
public class NutrientIntakeServiceTest {
    ...
    @Test
    public void testGetAllNutritionIntakeByRecordId_ValidRecordId_TransformCorrectlyIntoViewModel() throws RecordNotFoundException {
    ...
    @Test
    public void testGetAllNutritionIntakeByRecordId_InvalidRecordId_ThrowsException() throws RecordNotFoundException {
        Long invalidRecordId = 99L;
        when(repository.findAllByRecordId(invalidRecordId)).thenReturn(Optional.empty());    
