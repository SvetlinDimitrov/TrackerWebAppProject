...
class AchievementControllerTest {
    ...
    @Test
    public void updateAchievement_validAchievementDto_StatusNotContent() throws Exception {
    ...
    @Test
    public void updateAchievement_validAchievementDtoWithNullDate_StatusBadRequest() throws Exception {
    ...
    @Test
    public void updateAchievement_validAchievementDtoWithNullProgress_StatusBadRequest() throws Exception {
    ...
    @Test
    public void updateAchievement_validAchievementDtoWithNegativeProgress_StatusBadRequest() throws Exception {
    ...
    @Test
    public void updateAchievement_notExistingAchievementId_StatusBadRequest() throws Exception {
    ...
    @Test
    @Transactional
    public void updateAchievement_twoAchievementDtoWithTheSameDateReplaceDailyProgressTrue_TotalAchievementProgressReplacedStatusOk() throws Exception {
        ...
        assertTrue(result.getProgress().compareTo(new BigDecimal(20)) == 0);
        
    }
    
    @Test
    @Transactional
    public void updateAchievement_twoAchievementDtoWithTheSameDateReplaceDailyProgressFalse_TotalAchievementProgressAddedStatusOk() throws Exception {
        ...
        assertTrue(result.getProgress().compareTo(new BigDecimal(21)) == 0);
    }
    
    @Test
    public void getAchievementHolderById_validUserDataAndId_StatusOk() throws Exception {
    ...
    @Test
    public void getAchievementHolderById_validUserDataAndInvalidId_StatusBadRequest() throws Exception {
    ...
    @Test
    public void getAchievementHolderById_validDataWith1AchievementInsertion_validViewStatusOk() throws Exception {
    ...
    @Test
    public void getAchievementHolderById_validDataWith2AchievementInsertion_validViewStatusOk() throws Exception {
    ...
    @Test
    public void getAchievementHolderById_validDataWith2AchievementInsertionAnd1AchievementUpdate_validViewStatusOk() throws Exception {
    ...
    @Test
    public void changeAchievementTracker_validUserDataAndDto_StatusNoContent() throws Exception {
    ...
    @Test
    public void changeAchievementTracker_validUserDataAndDtoWithEmptyName_StatusNoContent() throws Exception {
    ...
    @Test
    public void changeAchievementTracker_validUserDataAndDtoWithNonValidData_StatusNoContent() throws Exception {
    ...
    @Test
    public void changeAchievementTracker_invalidAchievementId_StatusBadRequest() throws Exception {
    ...
    @Test
    public void changeAchievementTracker_validUserDataAndDtoWithAlreadyExistingName_StatusBadRequest() throws Exception {
    ...
    @Test
    public void deleteAchievement_validUserDataAndId_StatusNoContent() throws Exception {
    ...
    @Test
    public void deleteAchievement_invalidAchievementId_StatusBadRequest() throws Exception {
