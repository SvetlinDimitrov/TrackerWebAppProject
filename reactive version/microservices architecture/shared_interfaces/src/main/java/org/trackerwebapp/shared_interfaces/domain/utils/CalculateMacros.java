package org.trackerwebapp.shared_interfaces.domain.utils;
...
public class CalculateMacros {
  ...
  */
  public static BigDecimal calculateMacros(String name, BigDecimal dailyConsumedCalories,
      BigDecimal distributedMacros) {
